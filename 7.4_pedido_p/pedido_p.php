...
$resultado = $modelo->mostrar_pedido();
    ...
    if($resultado){
        foreach ($resultado as $row => $item){
            ...
            <td><a href="eliminar_p.php?id='.$item["codigo_p"].'"><i class="fas fa-trash" style="color:black"></i></a> | <a href="editar_p.php?id='.$item["codigo_p"].'"><i class="fas fa-edit" style="color:black"></i></a>
            </tr>
            </tbody>
            ';
        }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="Submit" class="btn btn-primary" value='Agregar'>Save changes</button>
      </div>
    </div>
  </div>
</div>
