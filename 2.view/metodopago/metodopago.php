...
<head>
    ...
    <link rel="stylesheet" href="methodpay.css">
    <style>
      #titlle{
        margin-top: 100px;
      }
...
<body>
    ...
    <div>
        <div id="marco">
            <img id="productpay" src="../image/metodopago/chaq.jpg" alt="">
        </div>
        <div>
            <h3 id="prize">precio</h3>
        </div>
        <div id="divtable">
            <table id="pagesmethod">
            <tr>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon1" class="imgformpay" src="../image/metodopago/visa.png" alt=""></td>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon12" class="imgformpay" src="../image/metodopago/mastercard.png" alt=""></td>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon3" class="imgformpay" src="../image/metodopago/paypal.png" alt=""></td>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon4" class="imgformpay" src="../image/metodopago/daviplata.jpg" alt=""></td>
            </tr>
            <tr>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon5" class="imgformpay" src="../image/metodopago/efecty.png" alt=""></td>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon6" class="imgformpay" src="../image/metodopago/contra.jpg" alt=""></td>
                <td><input class="checkpays" type="radio" name="gender" value=""></td>
                <td><img id="icon7" class="imgformpay" src="../image/metodopago/pse.jpg" alt=""></td>
            </tr>
        </table>
        </div>
        <br><br><br>
        <div id="pagespayexecute">
            <input class="buttonmethodpay" type="button" value="Comprar"><br><br>
            <input class="buttonmethodpay" type="button" value="Añadir al carrito">
        </div>
